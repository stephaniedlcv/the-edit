      ...
      <section className="mx-auto max-w-6xl px-6 py-10 md:px-10">
        <div className="grid gap-4 md:gap-5 md:grid-cols-3">
          {modeStats.map((stat) => (
            <article
              key={stat.label}
              className="rounded-[2px] bg-[var(--paper-2)] px-6 py-7 shadow-[inset_0_1px_0_rgba(255,255,255,0.8),0_0_0_1px_rgba(36,26,18,0.05),0_16px_44px_rgba(36,26,18,0.08)]"
            >
        ...
        <div className="mt-8 grid gap-4 md:gap-5">
          {outfitLogWeek.map((entry) => (
            <article
              key={entry.id}
              className="grid gap-5 rounded-[2px] bg-[var(--paper-2)] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.8),0_0_0_1px_rgba(36,26,18,0.05),0_16px_44px_rgba(36,26,18,0.08)] md:grid-cols-[9rem_1fr_16rem]"
            >
              <div>
              ...
              <aside className="rounded-[2px] bg-[var(--paper)] p-5 shadow-[inset_0_0_0_1px_rgba(36,26,18,0.06)]">
