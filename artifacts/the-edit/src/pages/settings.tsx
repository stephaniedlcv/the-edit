...
import { styleProfile as fallbackProfile } from "@/lib/style-profile";
...
export function SettingsPage() {
  const [styleProfile, setStyleProfile] = useState(fallbackProfile);

  useEffect(() => {
    getStyleProfile().then((result) => {
      setStyleProfile(result as typeof fallbackProfile);
    });
  }, []);
